...
exports.run = function() {
	...
	var picker_fee = _requires['util'].group({
	...
	var feeButton = _requires['util'].group({
		...
		feeButton.addEventListener('click', function(e) {
			picker_fee.animate(slide_in_fee);
		});
		...
		var indieBoardButton = _requires['util'].group({
			...
			'ib_button' : Ti.UI.createButton({
				backgroundColor : "transparent",
				title : L('label_tab_indieboard'),
				color : 'black',
				left : 5,
				textAlign : 'left',
				font : {
