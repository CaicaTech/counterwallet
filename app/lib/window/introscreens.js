	...
	nextButtonSuccess.addEventListener('click', function(e) {
		intro_scroll.scrollToView(view_passphrase);
	});
	...
	nextButtonPassphrase.addEventListener('click', function(e) {
		intro_scroll.scrollToView(view_passcode);
	});
	...
	skipButtonTouchid.addEventListener('click', function(e) {
		intro_scroll.scrollToView(view_complete);
	...
	if (OS_IOS) {
		var intro_scroll = Ti.UI.createScrollableView({
		...
		var intro_scroll = Ti.UI.createScrollableView({
  			views:[view_success,view_passphrase,view_passcode,view_complete],
  			showPagingControl:false,
  			scrollingEnabled:false
		});
	...
	function registEasyPass() {
					...
					var easyInput = _requires['util'].createEasyInput({
						...
						callback : function(number) {
							...
							_requires['cache'].save();
							if (OS_IOS) {
								intro_scroll.scrollToView(view_touchid);
							}
							else{
								intro_scroll.scrollToView(view_complete);
							}
